...
public class ErrorHandler {
    ...
    public ErrorResponse handleConstraintException(final ConstraintException e) {
        return new ErrorResponse("Произошла непредвиденная ошибка ConstraintException: " + e.getMessage());
    }
