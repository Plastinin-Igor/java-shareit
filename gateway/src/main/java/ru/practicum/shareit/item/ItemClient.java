...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> addItem(ItemCreateDto itemCreateDto, Long userId) {
        return post("", userId, itemCreateDto);
    }

    public ResponseEntity<Object> updateItem(ItemUpdateDto itemUpdateDto, Long itemId, Long userId) {
    ...
    public ResponseEntity<Object> findItems(String text, Long userId) {
