...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getBookingByUser(Long userId, BookingState state) {
        return get("?state=" + state, userId);
    }

    public ResponseEntity<Object> getBookingItemByUser(Long userId, BookingState state) {
